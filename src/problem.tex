...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/fig_bayes_diagram.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/fig_set_inclusion.png}
    \caption{集合包含关系示意图}
    \label{fig:set_inclusion}
\end{figure}
\end{example}
